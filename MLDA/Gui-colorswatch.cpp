...
{
    setObjectName(colorName + QLatin1String(""));
...
BlueTitleBar::BlueTitleBar(QWidget *parent,QString  title)
    : QWidget(parent)
{
    // 载入图像

    leftPm = QPixmap(":/res/Images/"+title+"titlebarLeft.png");
    centerPm = QPixmap(":/res/Images/titlebarCenter.png");
    rightPm = QPixmap(":/res/Images/titlebarRight.png");
}
BlueTitleBar::BlueTitleBar(QWidget *parent,bool closeable)
    : QWidget(parent)
{
    // 载入图像
    leftPm = QPixmap(":/res/Images/titlebarCenter.png");
    centerPm = QPixmap(":/res/Images/titlebarCenter.png");
    rightPm = QPixmap(":/res/Images/titlebarCenter.png");
    closeAble=closeable;
